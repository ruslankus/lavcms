...
<input type="hidden" name="current-lng-id" id="currrent-lng-id" value="{{ $lng_id }}" >
...
<div class="clearfix">
    <button type="submit" id="save-content" class="btn btn-default">Create slide content</button>
</div>